...
@Component({
  selector: 'app-usersonly',
  templateUrl: './usersonly.component.html',
  styleUrls: ['./usersonly.component.css']
})
export class UsersonlyComponent implements OnInit,AfterViewInit{
  itemSearch: any;
  itemsFind: any;
  searcha: any;
  displayedColumns=['name','username','mobileno','email','status','datecreated'];
